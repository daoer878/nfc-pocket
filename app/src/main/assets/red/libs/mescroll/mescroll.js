...
MeScroll.prototype.extendDownScroll = function(optDown) {
	...
	MeScroll.extend(optDown, {
		...
		htmlContent: '<p class="downwarp-progress"></p><p class="downwarp-tip">Loading... </p>', //布局内容
		...
		inOffset: function(mescroll) {
			...
			if(mescroll.downTipDom) mescroll.downTipDom.innerHTML = "Pull down to refresh...";
			if(mescroll.downProgressDom) mescroll.downProgressDom.classList.remove("mescroll-rotate");
		},
		outOffset: function(mescroll) {
			//下拉的距离大于offset那一刻的回调
			if(mescroll.downTipDom) mescroll.downTipDom.innerHTML = "Release to refresh...";
		},
		...
		showLoading: function(mescroll) {
			//显示下拉刷新进度的回调
			if(mescroll.downTipDom) mescroll.downTipDom.innerHTML = "Loading ...";
